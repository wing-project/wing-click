...
public:
	...
	void send_beacon(EtherAddress, EtherAddress, String, bool);
	void send_beacon(EtherAddress, EtherAddress, Vector<String>, bool);
	void send_beacon(EtherAddress, EtherAddress, Vector<String>, String, bool);
