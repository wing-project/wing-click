...
lt :: LinkTableMulti(IP 6.35.170.123, IFACES " 1 2", BETA 80, DEBUG true);
...
dyn :: DynGW(wing-mesh, 6.35.170.123, 255.0.0.0);
...
# 0 "<click-align>"
AlignmentInfo@click_align@82 :: AlignmentInfo(cl  4 2,
  Classifier@40  4 0,
  Classifier@49  4 0,
  wr/check_ip  4 0,
  wr/ncl  4 2,
